...
-->
<!DOCTYPE HTML>
<%@page import="com.haipham.connection.ProductDAO"%>
<html>
<head>
						...
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="0men.html">Handbags</a></li>
									<li><a href="men.html">Trousers</a></li>
									<li><a href="men.html">Jeans</a></li>
		...
		<div class="col-md-9 cart-items">
			 ...
			 <form action="RemoveCartServlet" method="post">
				 <div class="close1">
				 	...
				 	<input type="hidden" name="id_pro" value="<%=ms%>"/>
				 	<input type="image" src="images/delete.jpg" name="submit"value="Remove" style="float:right">
					<!-- <input type="submit" value="Remove"/>	 -->
				 </div>
				 </form>
				   <div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							 <img src="images/<%=productImpl.getProduct(c.getP().getID()).getImage() %>.jpg" class="img-responsive" alt=""/>
						</div>
					   <div class="cart-item-info">
						<h3><a href="#"><%=productImpl.getProduct(c.getP().getID()).getName() %></a><span>Model No: NONE</span></h3>
						<ul class="qty">
							<li><p>Size : Normal</p></li>
							<li><p>Qty : <%=c.getQuantity() %></p></li>
						</ul>
						<div class="delivery">
							 <p>Service Charges : NO</p>
			 ...
			 <!-- <div class="cart-header2">
				 <div class="close2"> </div>
				  <div class="cart-sec simpleCart_shelfItem">
					   ...
					   <div class="cart-item-info">
						<h3><a href="#">Mountain Hopper(XS R034)</a><span>Model Fashion</span></h3>
						<ul class="qty">
							<li><p>Size : Normal</p></li>
							<li><p>Qty : </p></li>	So Luong 
						</ul>
							 <div class="delivery">
							 <p>Service Charges : NO</p>
							 <span>Delivered in 2-3 business days</span>
		 ...
		 <div class="col-md-3 cart-total">
			 ...
			 <a class="continue" href="basket.jsp">Continue to basket</a>
			 <div class="price-details">
				 <h3>Price Details</h3>
				 <span>Total</span>
				 <span class="total1"><%=total %></span>	<!--Gia tien mon hang   -->
				 <span>Discount</span>
				 <span class="total1">---</span>
				 <span>Delivery Charges</span>
				 <span class="total1">15$</span>		<!--tien van chuyen  --> 
				 <div class="clearfix"></div>				 
			 </div>	
			 <ul class="total_price">
			   <li class="last_price"> <h4>TOTAL</h4></li>	
			   <li class="last_price"><span><%=totalfinal %></span></li>	<!-- Tien Hang Tong cong -->
			   <div class="clearfix"> </div>
			 </ul>
			 <div class="clearfix"></div>
