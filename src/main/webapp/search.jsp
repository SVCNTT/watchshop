...
list = add.getProductString(search);
								...
								<div class="product_image">
									...
									<div class="mask">
					                 ...
					                 <div class="product_container">
									   ...
									   <a class="button item_add cbp-vm-icon cbp-vm-add" href="CartServlet?type=search&command=addCart&product_id=<%=p.getID()%>">Add to cart</a>
									 </div>		
								  </div>
			                     </div>
		                      </div>
