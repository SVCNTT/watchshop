...
-->
<!DOCTYPE HTML>
<%@page import="com.haipham.model.CartInfos"%>
...
<%@page import="com.haipham.model.Account"%>
...
%>
	...
	<%
           ...
           <div class="header_top_right">
			 ...
			 <%
			  ...
			  <a class="login" href="#">
				<i class="user"> </i> 
				<li class="user_desc">Hello <%=username %></li>
			  </a>
			  <%}else{ %>
   ...
   <div class="account-in">
		...
		if ((request.getAttribute("thank") != null) &&
			(request.getAttribute("thank1") != null) &&
			(request.getAttribute("thank2") != null) &&
			(request.getAttribute("thank3") != null))
			
		{
			thank = (String) request.getAttribute("thank");
			thank1 = (String) request.getAttribute("thank1");
			thank2 = (String) request.getAttribute("thank2");
			thank3 = (String) request.getAttribute("thank3");
		
		
	%>
		  	<div>
		  		
		  		<span style="color:black">- Thanks <b style="color:blue"><%=thank %></b> has purchased our products !</span>
		  		<span style="color:black">- Your products will be send to : <b style="color:blue"><%=thank1 %></b></span>
		  		<span style="color:black">- Shipper will contact you via phone number :<b style="color:blue"><%=thank2 %></b></span>
		  		<span style="color:black">- Intend Time : <b style="color:blue"><%=thank3 %></b></span>
		  	...
		  	<div> 	
				<span style="color:black">PRODUCT NAME :  </span>
				 <%						int productID=0;
									...
									%>
				<span><%=productImpl.getProduct(c.getP().getID()).getName() %> x 
														 <%=c.getQuantity() %> = 
														 <%=productImpl.getProduct(c.getP().getID()).getPrice()*c.getQuantity() %> $
				
				</span>
					
				<%System.out.println("Product id la "+productID+"co tong cong : "+c.getQuantity()+" san pham "); %>
			...
			<div>
				<span style="color:black">Shipping Cost : 15$</span>
			</div>
			<div> 	
				<span style="color:black">TOTAL : <%=totalfinal %> $</span>
				 <input type="hidden" name="price_sum" value="<%=totalfinal %>">
			</div>
			<div>
				<%
				//List<Account> listAccount = new ArrayList<Account>();
					...
					listAcc = accountImpl.getList();
					
					List<CartInfos> listCart = new ArrayList<CartInfos>();
					listCart = productImpl.getListCart();
					%>
					...
					for (Account a : listAcc){
						  if (session.getAttribute("username").equals(a.getUsername())){
						 	id_customer = a.getId(); 
						}  
					}
				%>
