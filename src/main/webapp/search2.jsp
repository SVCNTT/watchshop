    ...
    <div class="container">
    	<div class="col-md-4 sidebar_men">
    	 ...
    	 <ul class="product-categories color">
    	  <%
    	  		ProductImpl cat = new ProductImpl();
    	  		List<Category> cate_list = new ArrayList<Category>();
    	  		cate_list = cat.getCategoryType();
								...
								<div class="product_image">
									...
									<div class="mask">
					                 ...
					                 <div class="product_container">
									   ...
									   <a class="button item_add cbp-vm-icon cbp-vm-add" href="CartServlet?type=search2&command=addCart&product_id=<%=p.getID()%>">Add to cart</a>
									 </div>		
								  </div>
			                     </div>
		                      </div>
